# Trendora Fashion – Full Stack eCommerce Web Application + Admin Panel


![Trendora Image Banner](https://i.ibb.co/vckrzmN/Trendora-fashion-banner.png)

Trendora fashion is a powerful and modern full stack eCommerce web application built using Next.js, Express.js, MongoDB with Mongoose, Redux Toolkit, RTK Query, Stripe payment method, Bootstrap 5, and Sass. It includes a feature-rich admin panel for easy management and control of your online store.
...
- **Authentication:** Trendora includes features for Google login, user registration, email verification, forgot password, reset password, and profile updates.
...
- **Typescript + Next.js App Directory:** Trendora leverages TypeScript in combination with Next.js, enhancing code reliability and maintainability.
...
- **Responsive Layout Design:** Trendora is fully responsive across all devices, providing a seamless experience for your customers.
...
- **Flexible and Multi-Purpose:** Trendora is versatile and can be adapted to various eCommerce niches.
...
- **All E-commerce Features and Apps Included:** Trendora provides a comprehensive eCommerce solution with all the essential features and apps needed for a successful online store.
...
To get started with Trendora, follow these steps:

1. Clone the repository:

   ```bash
   https://github.com/Hamed-Hasan/Trendora-fashion-ecommerce-client.git
   ```
...
[Trendora Fashion Client Side Live Link](https://Trendora-fashion-ecommerce-client.vercel.app)

## Server Side Live Link

[Trendora Fashion Server Side Live Link](https://Trendora-backend.vercel.app)

## Client Side Repo

[Trendora fashion Client Side Repo](https://github.com/Hamed-Hasan/Trendora-fashion-ecommerce-client.git)

## Server Side Repo

[Trendora fashion Server Side Repo](https://github.com/Hamed-Hasan/Trendora-fashion-ecommerce-backend.git)
...
## Thank You for Choosing Trendora!

We hope you find Trendora to be a powerful and effective solution for your eCommerce needs. Should you encounter
